...
<body>
    ...
    <div class="container-page" id="Container">
        <div class="login-container" id="LoginContainer">
            ...
            <form action="conexionPasajeros.php" method="POST">
                <div class="input-line-container">
                    <span class="name-input">Nombre</span>
                    <input type="text" name="NombrePasajero" class="input-line" id="name-input" placeholder="Ingrese su nombre">
                </div>
                <div class="input-line-container">
                    <span class="name-input">Apellido</span>
                    <input type="text" name="Apellido" class="input-line" id="country-input"placeholder="Ingrese su apellido">
                </div>

                <div class="input-line-container">
                    <span class="name-input">Edad</span>
                    <input type="text" name="Edad" class="input-line" id="country-input"placeholder="Ingrese su edad">
                </div>
